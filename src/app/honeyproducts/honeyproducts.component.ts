...
@Component({
  selector: 'app-honeyproducts',
  standalone: true,
  imports: [ProductsDetailsComponent],
  templateUrl: './honeyproducts.component.html',
  styleUrl: './honeyproducts.component.css'
})
export class HoneyproductsComponent  implements OnInit,OnChanges,OnDestroy{
