...
@Component({
  selector: 'app-naturalproducts',
  standalone: true,
  imports: [ProductsDetailsComponent],
  templateUrl: './naturalproducts.component.html',
  styleUrl: './naturalproducts.component.css'
})
export class NaturalproductsComponent  implements OnInit,OnChanges,OnDestroy{
