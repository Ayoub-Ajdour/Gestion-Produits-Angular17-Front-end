...
import { PromoproductsdetailsComponent } from '../promoproductsdetails/promoproductsdetails.component';

@Component({
  selector: 'app-favoriteproducts',
  standalone: true,
  imports: [PromoproductsdetailsComponent],
  templateUrl: './favoriteproducts.component.html',
  styleUrl: './favoriteproducts.component.css'
})
export class FavoriteproductsComponent  implements OnInit,OnChanges,OnDestroy{
...
throw new Error('Method not implemented.');
  ...
  deleteProduct(p:product):void{
    ...
    var confirmationMessage = "Are you sure you want to delete " + productName + " ?";
